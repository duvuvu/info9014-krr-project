...
│   ├── csv-data/                #   16 TSV source files (IMDb non-commercial sample)
│   └── README.md
│
...
|-----------|-------------|--------|
| M1 | Relational database design and population | Done |
| M2 | OWL 2 QL ontology engineering | Done |
| M3 | R2RML mapping and KG generation | Done |
| M4 | Fuseki deployment, SPARQL queries, demonstrator | Done |
